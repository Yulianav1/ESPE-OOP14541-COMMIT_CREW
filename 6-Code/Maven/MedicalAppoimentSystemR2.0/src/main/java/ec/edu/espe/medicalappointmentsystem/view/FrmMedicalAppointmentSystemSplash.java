 ...
 * @author MSI-PULSE
 */
public class FrmMedicalAppointmentSystemSplash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("(c) 2024 Commit Crew");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMedicalAppointmentSystemSplash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMedicalAppointmentSystemSplash().setVisible(true);
            }
        });
    }
